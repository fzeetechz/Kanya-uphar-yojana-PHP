                  ...
                  <tr>
                     ...
                     <td class="action ">
                        ...
                        @if(Auth::user()->hasPermissionTo('users.update'))
                           <a class="icon-btn edit" href="{{ route('Roles.edit',$role->id) }}"><i class="fal fa-trash-alt" id="delete-btn"></i></a>
                        @endif 
                           <a class="icon-btn preview" href="{{ route('Roles.show',$role->id) }}"><i class="fal fa-eye" id="show-btn"></i></a>
                           <a class="icon-btn edit" href="{{ route('Roles.edit',$role->id) }}"><i class="fal fa-edit" id="show-edit"></i></a>                     </td>
                  </tr>
                  @endforeach 
               </tbody>
            </table>
