   ...
   <div class="card-body">
      <form action="{{ route('settings.contactussettings.address.store',$id) }}" method="POST" id="formid" name="formid">
         ...
         <label for="nf-name">Address</label>
            <textarea class="form-control" autocomplete="random"  rows="3" style="height: auto;" id="address" name="address">@if($updatedata!=''){{$updatedata->address}}  @endif</textarea>
                     ...
                     <tbody>
                        ...
                        <tr class="{{$value->id}}">
                           ...
                           <td class="action ">
                              ...
                              <a class="icon-btn delete universaldelete" href="javascript:void(0);" data-status="0" data-id="{{ $value->id}}"  data-model="Address" id="{{$value->id}}" > <i class="fal fa-trash-alt" id="delete-btn"></i></a> 
                           </td>
                        </tr>
                        @endforeach
                     </tbody>
