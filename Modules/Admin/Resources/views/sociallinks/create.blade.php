...
@section('title') Add Social link  @endsection
@section('content')
      ...
      <div class="col-md-6">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb m-0 p-0">
               ...
               <li class="breadcrumb-item active" aria-current="page">Create Social link</li>
            </ol>
         </nav>
      </div>
   </div>
...
<div class="card">
  <div class="card-header">
    <strong>Create Social link</strong>
   ...
   <div class="card-body">
      <form action="{{ route('sociallinks.store') }}" method="POST" enctype="multipart/form-data" id="formid" name="formid">
         {{ csrf_field() }}
         <div class="form-group col-md-8">
            <label for="nf-name">Name</label>
            <input class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" autocomplete="random" value="{{ old('name') }}" id="nf-name" name="name" type="text" 
         ...
         <div class="form-group col-md-8">
            ...
            <input class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" autocomplete="random" value="{{ old('title') }}"  id="nf-title" name="title" type="text" 
         ...
         <div class="form-group col-md-8">
            ...
            <input class="form-control {{ $errors->has('url') ? ' is-invalid' : '' }}" autocomplete="random" value="{{ old('url') }}" id="nf-url" name="url" type="url" 
