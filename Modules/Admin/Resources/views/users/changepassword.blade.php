         ...
         <div class="col-md-6">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb m-0 p-0">
                  ...
                  <li class="breadcrumb-item"><a href="{{route('users.admin.managers')}}">User</a></li>
         ...
         <div class="card-header">
            <div class="d-flex justify-content-between">
               ...
               <div>
                  ...
                  <a class="btn btn-sm btn-info " href="{{ route('users.adminmanagerprofile',$id) }}"  style="font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif;">Profile</a>
