...
<div class="main-content">
    ...
    <div class="card">
        <div class="card-header"><strong>Fill Content</strong> <a
                class="btn btn-sm btn-info float-right  rounded-pill ml-5 ml-lg-2"
        ...
        <div class="card-body">
            <form action="{{ route('banners.store') }}" id="formid" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" id="nf-title"
                        name="title" type="text" placeholder="Enter page title.." value="{{@$data->title}}"
                        autocomplete="title">
                    @if ($errors->has('title'))
                ...
                <div class="form-group ">
                    ...
                    <input type="file" name="banner" id="exampleInputImage"
                        class="form-control image {{ $errors->has('banner') ? ' is-invalid' : '' }}">
