...
<html>
   ...
   <body>
      <div class="login-page">
         <div class="login-box">
            ...
            <div class="contentBox">
               <div class="logo d-flex flex-wrap w-100">
                  <a href="{{route('front.index')}}">  <img src="{{ asset('front/assets/images/logo-9.png')}}" alt="Logo"></a>
               </div>
               <h4>Welcome to Kanya Uphar Yojana </h4>
         ...
         <div class="col-lg-6 col-md-12">
            <div class="imgBox">                                     
               <div class="bg-background" style="background-image: url({{ asset('front/assets/images/backgrounds/background-2.jpg') }});"></div>
